...
public final class EventCardLayoutBinding implements ViewBinding {
  ...
  private EventCardLayoutBinding(@NonNull ConstraintLayout rootView,
      @NonNull TextView eventCapacity, @NonNull TextView eventDatetime,
      @NonNull TextView eventLanguage, @NonNull TextView eventLocation, @NonNull TextView eventName,
      @NonNull ImageView eventPhoto) {
  ...
  public static EventCardLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new EventCardLayoutBinding((ConstraintLayout) rootView, eventCapacity, eventDatetime,
